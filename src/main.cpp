...
uint256 hashGenesisBlock("0xdd4c97b46b2166329cf19116aa66c4d457e76cc10dfd924c1702c9c9f68f1b26");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // travelcoin: 0.35 days
static const int64 nTargetSpacing = 120; // travelcoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal travelcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "travelcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdd4c97b46b2166329cf19116aa66c4d457e76cc10dfd924c1702c9c9f68f1b26");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "epoch 1387580434: replace with something that ensures no premining took place";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387582446;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 387309603;//440824;
       ...
       assert(block.hashMerkleRoot == uint256("0xd262e5072a425efdf4aabac0c4207c135e1cc4791be79753b4e053bc8744dc45"));
